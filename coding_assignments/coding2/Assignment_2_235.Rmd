...
boxplot(plot_df, 
        main = "MSPE for Simulation Study",
        las = 2)
stripchart(plot_df,
           vertical = TRUE,
           add = TRUE)
...
## Part c Answers: 
1. The best MSPE performance is yielded by the ridge procedure. 
2. The worst MSPE performance is yielded by the full linear procedure. 
3. Lasso.min yields better performance.
4. Refitting is not advantageous because the refit model does not outperform the lasso 1se model. 
5. Variable selection is warranted for this dataset. The performance of full model is significantly worse than fine tuned models. 
...
## Part c Answers: 
1. The best MSPE performance is yielded by the ADF procedure. 
2. The worst MSPE performance is yielded by the ADF procedure. 
3. Lasso.min yields better performance
4. Refitting is advantageous because the refit model outperforms the lasso 1se model. 
5. Variable selection is warranted for this dataset. The performance of full model is significantly worse than fine tuned models. 
