...
## Part c Answers: 
1. Min lasso performs the best.
2. PCR performs the poorest. 
3. All models perform worse, however in particular PCR and ridge perform much more poorly. ~ADDITIONAL WORDS~ 