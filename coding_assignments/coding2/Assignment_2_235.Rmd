...
2. The worst MSPE performance is yielded by the lasso 1se model.
3. Lasso.min yields better performance.
4. Refitting is slightly advantageous but the improvement is likely negligible.
...
# load data
case2_data = read.csv("Coding2_Data2.csv")
