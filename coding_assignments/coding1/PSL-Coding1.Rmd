...
| Joe May        | Part 1-1, 1-2, 1-3, 2-1, 2-3 |
...
If there are distance ties when determining nearest neighbors, all neighbors of
that distance from the test point are included in the voting process.

If the number of votes for each point is the same, we have decided to 
