...
bayes_rule = function(x, s, m1, m0) {
  ...
  cluster_count = nrow(m1)
  numerator = rep(0, nrow(x))
  denominator  = rep(0, nrow(x))
  
  # iterate through clusters, and sum for each
  for(cluster in cluster_count){
    current_m1 = m1[cluster, ]
    current_m0 = m0[cluster, ]
    ...
    # calculate numerator and denominator portions for each cluster
...
predicted = bayes_rule(testdata, s, m1, m0)
actual = Ytest
print(table(actual, predicted))
