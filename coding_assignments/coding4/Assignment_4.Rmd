...
myEM = function(data, G, init_params, itmax) {
  for(i in 1:itmax) {
    ...
    #out_params = Mstep(data, G, init_params, post_prob)
  }
...
initial = list(prob=c(p1, p2), mean=cbind(u1, u2), Sigma=sigma)

# evaluate 
out = myEM(data=test_df, G=G, init_params=initial, itmax=max_iteration)
