...
p4 = 50/n
p5 = 50/n
p6 = 1 - sum(c(p1, p2, p3, p4, p5))

# slice x into x1 x2, and x3 to simplify code later
x1 = as.matrix(test_df[1:10, ])
x2 = as.matrix(test_df[11:30, ])
x3 = as.matrix(test_df[31:60, ])
x4 = as.matrix(test_df[61:100, ])
x5 = as.matrix(test_df[101:150, ])
x6 = as.matrix(test_df[151:n, ])
...
init_params = list(prob=c(p1, p2, p3, p4, p5, p6), mean=cbind(u1, u2, u3, u4, u5, u6), Sigma=sigma)
